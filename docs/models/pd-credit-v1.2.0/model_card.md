...
model_uuid: bddfb8b7-75f2-4e33-84cf-85650ac42c2d
status: draft
template_version: 1
---
...
- Name: ModelGuard PD model (`pd-credit-v1.2.0`), immutable UUID `bddfb8b7-75f2-4e33-84cf-85650ac42c2d`
...
- Lineage: source `synthetic-loans-v1` → snapshot `26bc0b93-87df-42aa-8a85-1235d386e5b3` → training run `4dd2b2d2-9818-4fff-b9df-ff237f74a872` → model version `pd-credit-v1.2.0`
